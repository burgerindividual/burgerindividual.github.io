// from https://github.com/Drigax/RooftopRampage_Source/blob/master/public/Shaders/crt.fragment.fx
...
void main(void)
{
    vec2 remappedUV = curveRemapUV(vec2(vTextureCoord.x, vTextureCoord.y));
    vec4 baseColor = texture2D(uRenderTexture, remappedUV);
